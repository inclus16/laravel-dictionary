...
use Inclus16\LaravelDictionary\Validation\Rules\InDictionary;
use Orchestra\Testbench\TestCase;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;

#[CoversClass(InDictionary::class)]
#[CoversClass(DictionaryServiceProvider::class)]
#[CoversClass(AbstractDictionaryHandler::class)]
#[CoversClass(HandlerFactory::class)]
class InDictionaryValidationRuleTest extends TestCase
{
    use CacheMocks;
    use ConfigMocks;
    ...
    public function testValidationPassed(string $name)
    {
        $data = [
            'testField' => $name
        ];
        ...
        $result = Validator::make($data, [
            'testField' => new InDictionary('test', 'name')
        ]);
    ...
    public function testValidationFailed()
    {
        ...
        self::assertEquals([
            'testField' => ["The {$data['testField']} not found in dictionary test"]
